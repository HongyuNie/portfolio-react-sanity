    ...
    return (
        <main className="bg-blue-100 min-h-screen p-12">
            <section className="container mx-auto">
                ...
                {/* mapping over all the imformation that is clickable */}
                    ...
                    <article>
                        ...
                        <span className="block h-64 relative rounded shadow leading-snug bg-white border-l-8 border-blue-400" key={index}>
                            ...
                            <span className="block relative h-full flex justify-end items-end pr-4 pb-4">
                                <h3 className="text-grey-800 text-lg font-bold px-3 py-4 bg-blue-700 text-red-100 bg-opacity-75 rounded">{post.title
                                }</h3>
                            </span>
                        </span>
                        </Link>
